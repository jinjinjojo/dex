...
local function Ripple(Button, x, y)
	...
	Ripple.Image = "rbxassetid://5413752267"
...
if _G.Settings['Intro'] == true then
	...
	Pieces.BackgroundColor3 = Color3.fromRGB(255,215,0)
	...
	Pieces_2.BackgroundColor3 = Color3.fromRGB(255,165,0)
	Pieces_2.Rotation = 0
	
	Pieces_3 = Pieces:Clone()
	Pieces_3.Parent = Background
	Pieces_3.BackgroundColor3 = Color3.fromRGB(255,140,0)
	...
	TitleFrame.ImageColor3 = Color3.fromRGB(210,105,30)--211,189,87
...
MainFrame.ImageColor3 = Color3.fromRGB(184,156,61)
...
InfoFrame.ImageColor3 = Color3.fromRGB(181, 181, 181)
InfoFrame.ImageTransparency = 0.600
...
Icon.Image = "http://www.roblox.com/asset/?id=465107434"
...
TabsControl.BackgroundColor3 = Color3.fromRGB(211,189,87)
...
Bind.Image = "rbxassetid://5413752267"
Bind.ImageColor3 = Color3.fromRGB(211,189,87)
Bind.ImageTransparency = 0.600
...
function Library:CreateTab(Name)
	...
	Tab.BackgroundColor3 = Color3.fromRGB(211,189,87)
	...
	TabFrame.BackgroundColor3 = Color3.fromRGB(211,189,87)
	...
	Opened:GetPropertyChangedSignal("Value"):Connect(function()
		if Opened.Value == true then
			...
			Tab.BackgroundColor3 = Color3.fromRGB(211,189,87) --may need to change
		else
	...
	function TabLibrary:Button(Text, Function)
		...
		Button.Active = false
		Button.BackgroundColor3 = Color3.fromRGB(211,189,87)
	...
	function TabLibrary:Dropdown(Placeholder, Contents, Function)
		...
		Dropdown.BackgroundColor3 = Color3.fromRGB(211,189,87)
		...
		Arrow.Image = "http://www.roblox.com/asset/?id=5413752267"
		...
		Selection.BackgroundColor3 = Color3.fromRGB(211,189,87)
	...
	function TabLibrary:Toggle(ToggleText, Status, Function)
		...
		local function CheckToggle()
			...
			if ToggleSwitch == true then
				...
				Ripple.ScaleType = Enum.ScaleType.Slice
				Ripple.SliceCenter = Rect.new(100, 100, 100, 100)
				local RippleFx = MakeTween(Ripple, TweenInfo.new(0.15), {Size = UDim2.new(1.5, 0, 1.5, 0), ImageTransparency = 0.2})
				RippleFx:Play()
				RippleFx.Completed:Wait()
				ToggleBox.Image = 'http://www.roblox.com/asset/?id=5228569533'
				Ripple:Destroy()
	...
	function TabLibrary:TextBox(TitleText, Placeholder, Function)
		...
		TextBoxFrame.Image = "rbxassetid://5413752267"
		TextBoxFrame.ImageColor3 = Color3.fromRGB(211,189,87)
